...
class PigeonOccupantInfo {
  ...
  PigeonOccupantRole role;

  int passengerProbability;
  ...
  static PigeonOccupantInfo decode(Object result) {
    result as List<Object?>;
    return PigeonOccupantInfo(
      role: result[0]! as PigeonOccupantRole,
      passengerProbability: result[1]! as int,
    );
  }
}
...
class PigeonTrip {
  ...
  PigeonOccupantInfo? occupantInfo;
  ...
  static PigeonTrip decode(Object result) {
    ...
    return PigeonTrip(
      ...
      pollutants: result[18] as PigeonPollutants?,
      tireWear: result[19] as PigeonTireWear?,
      brakeWear: result[20] as PigeonBrakeWear?,
      driverDistraction: result[21] as PigeonDriverDistraction?,
      logbook: result[22] as PigeonLogbook?,
      occupantInfo: result[23] as PigeonOccupantInfo?,
      safetyEvents: (result[24] as List<Object?>?)?.cast<PigeonSafetyEvent?>(),
      speedingStatistics: result[25] as PigeonSpeedingStatistics?,
      energyEstimation: result[26] as PigeonEnergyEstimation?,
      advancedEnergyEstimation: (result[27] as List<Object?>?)
          ?.cast<PigeonAdvancedEnergyEstimation?>(),
      tripAdvicesData:
          (result[28] as List<Object?>?)?.cast<PigeonTripAdviceData?>(),
      maneuverData: result[29] as PigeonManeuverData?,
      evaluationData: result[30] as PigeonEvaluationData?,
      metadata:
          (result[31] as Map<Object?, Object?>?)?.cast<String?, String?>(),
      transportationMode: result[32]! as int,
      declaredTransportationMode:
          result[33] as PigeonDeclaredTransportationMode?,
      unscored: result[34]! as bool,
      calls: (result[35] as List<Object?>?)?.cast<PigeonCall?>(),
      speedLimitContexts:
          (result[36] as List<Object?>?)?.cast<PigeonSpeedLimitContext?>(),
    );
  }
}
...
class PigeonCurrentTripInfo {
  ...
  static PigeonCurrentTripInfo decode(Object result) {
    result as List<Object?>;
    return PigeonCurrentTripInfo(
      localTripId: result[0]! as String,
      date: result[1]! as String,
      startMode: result[2]! as PigeonStartMode,
    );
  }
}
...
class PigeonLastTripLocation {
  ...
  PigeonAccuracyLevel accuracyLevel;
  ...
  static PigeonLastTripLocation decode(Object result) {
    result as List<Object?>;
    return PigeonLastTripLocation(
      date: result[0]! as String,
      latitude: result[1]! as double,
      longitude: result[2]! as double,
      accuracyMeter: result[3]! as double,
      accuracyLevel: result[4]! as PigeonAccuracyLevel,
    );
  }
}
...
class PigeonTripRecordingStartedState {
  ...
  static PigeonTripRecordingStartedState decode(Object result) {
    result as List<Object?>;
    return PigeonTripRecordingStartedState(
      localTripId: result[0]! as String,
      recordingStartDate: result[1]! as String,
      startMode: result[2]! as PigeonStartMode,
    );
  }
}
...
class PigeonTripRecordingConfirmedState {
  ...
  String recordingConfirmationDate;
  ...
  static PigeonTripRecordingConfirmedState decode(Object result) {
    result as List<Object?>;
    return PigeonTripRecordingConfirmedState(
      localTripId: result[0]! as String,
      recordingStartDate: result[1]! as String,
      recordingConfirmationDate: result[2]! as String,
      startMode: result[3]! as PigeonStartMode,
    );
  }
}
...
class PigeonTripRecordingCanceledState {
  PigeonTripRecordingCanceledState({
    required this.localTripId,
    required this.recordingStartDate,
    this.recordingConfirmationDate,
    required this.startMode,
  ...
  PigeonTripCancelationReason cancelationReason;
  ...
  static PigeonTripRecordingCanceledState decode(Object result) {
    result as List<Object?>;
    return PigeonTripRecordingCanceledState(
      ...
      recordingConfirmationDate: result[2] as String?,
      startMode: result[3]! as PigeonStartMode,
      cancelationReason: result[4]! as PigeonTripCancelationReason,
    );
  }
}
...
class PigeonTripRecordingFinishedState {
  ...
  static PigeonTripRecordingFinishedState decode(Object result) {
    result as List<Object?>;
    return PigeonTripRecordingFinishedState(
      ...
      recordingConfirmationDate: result[2]! as String,
      startMode: result[3]! as PigeonStartMode,
      recordingEndDate: result[4]! as String,
    );
  }
}
...
class PigeonCreateTripSharingLinkResponse {
  ...
  PigeonCreateTripSharingLinkStatus status;
  ...
  static PigeonCreateTripSharingLinkResponse decode(Object result) {
    result as List<Object?>;
    return PigeonCreateTripSharingLinkResponse(
      status: result[0]! as PigeonCreateTripSharingLinkStatus,
...
class IOSTripAnalysisApi {
  ...
  Future<PigeonCurrentTripInfo?> getCurrentTripInfo() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as PigeonCurrentTripInfo?);
    }
  }
  ...
  Future<PigeonLastTripLocation?> getLastTripLocation() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as PigeonLastTripLocation?);
    }
  }
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          try {
            api.tripRecordingStarted(arg_state!);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          try {
            api.tripRecordingConfirmed(arg_state!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          try {
            api.tripRecordingCanceled(arg_state!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          try {
            api.tripRecordingFinished(arg_state!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
