...
class IOSTripAnalysisApi {
  ...
  Future<PigeonTripResponseStatus?> getTripResponseStatus(PigeonPostGenericResponse tripResponse) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.pigeon_trip_analysis_package.IOSTripAnalysisApi.getTripResponseStatus$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
