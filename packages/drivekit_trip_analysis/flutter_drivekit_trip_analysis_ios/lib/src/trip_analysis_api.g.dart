...
class IOSTripAnalysisApi {
  ...
  Future<void> setBeacons(List<PigeonBeaconData?> beacons) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.pigeon_trip_analysis_package.IOSTripAnalysisApi.setBeacons$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<void> setBeaconRequired(bool required) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.pigeon_trip_analysis_package.IOSTripAnalysisApi.setBeaconRequired$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
