...
in the front facing package `drivekit_trip_analysis` example. 
...
```sh
cd drivekit_trip_analysis/example
fluttium test flows/test_platform_name.yaml
```

[coverage_badge]: drivekit_trip_analysis/coverage_badge.svg
