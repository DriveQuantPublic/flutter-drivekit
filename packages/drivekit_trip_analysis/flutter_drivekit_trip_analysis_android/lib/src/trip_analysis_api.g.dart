...
class PigeonBeaconData {
  ...
  static PigeonBeaconData decode(Object result) {
    result as List<Object?>;
    return PigeonBeaconData(
      proximityUuid: result[0]! as String,
...
class AndroidTripAnalysisApi {
  ...
  Future<void> setBeacons(List<PigeonBeaconData?> beacons) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.pigeon_trip_analysis_package.AndroidTripAnalysisApi.setBeacons$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<void> setBeaconRequired(bool required) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.pigeon_trip_analysis_package.AndroidTripAnalysisApi.setBeaconRequired$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_beacon != null,
              'Argument for dev.flutter.pigeon.pigeon_trip_analysis_package.FlutterTripAnalysisApi.beaconConfirmed was null, expected non-null PigeonBeaconData.');
          try {
            api.beaconConfirmed(arg_beacon!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
