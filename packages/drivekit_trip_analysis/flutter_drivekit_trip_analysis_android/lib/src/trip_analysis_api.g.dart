...
class PigeonPostGenericResponse {
  ...
  static PigeonPostGenericResponse decode(Object result) {
    ...
    return PigeonPostGenericResponse(
      ...
      driverDistraction:
          (result[15] as List<Object?>?)?.cast<PigeonDriverDistraction?>(),
      ...
      speedingEvents:
          (result[21] as List<Object?>?)?.cast<PigeonSpeedingEvents?>(),
...
class PigeonPostGeneric {
  ...
  static PigeonPostGeneric decode(Object result) {
    ...
    return PigeonPostGeneric(
      ...
      phoneCalls:
          (result[6] as List<Object?>?)?.cast<PigeonPhoneCallRequest?>(),
...
class PigeonSpeedingStatistics {
  ...
  static PigeonSpeedingStatistics decode(Object result) {
    ...
    return PigeonSpeedingStatistics(
      ...
      speedLimitContexts:
          (result[5] as List<Object?>?)!.cast<PigeonSpeedLimitContext?>(),
    );
  }
}
...
class AndroidTripAnalysisApi {
  ...
  Future<bool> getMonitorPotentialTripStart() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.pigeon_trip_analysis_package.AndroidTripAnalysisApi.getMonitorPotentialTripStart$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final PigeonPostGenericResponse? arg_response =
              (args[1] as PigeonPostGenericResponse?);
