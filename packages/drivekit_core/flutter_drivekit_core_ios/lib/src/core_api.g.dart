...
class PigeonGetUserInfoResponse {
  ...
  static PigeonGetUserInfoResponse decode(Object result) {
    ...
    return PigeonGetUserInfoResponse(
      ...
      userInfo: result[1] as PigeonGetUserInfo?,
    );
  }
}
...
class PigeonGetUserInfo {
  ...
  static PigeonGetUserInfo decode(Object result) {
    result as List<Object?>;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is PigeonUserInfo) {
      ...
      buffer.putUint8(130);
      writeValue(buffer, value.encode());
    } else     if (value is PigeonGetUserInfo) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 131: 
        return PigeonGetUserInfo.decode(readValue(buffer)!);
      case 132: 
...
class IOSCoreApi {
  ...
  Future<PigeonGetUserInfoResponse> getUserInfo({PigeonSynchronizationType synchronizationType = PigeonSynchronizationType.defaultSync}) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.pigeon_core_package.IOSCoreApi.getUserInfo$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<bool> updateUserInfo(PigeonUserInfo userInfo) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.pigeon_core_package.IOSCoreApi.updateUserInfo$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
